...
import { serviceRepository, type CreateServiceInput } from "@/server/repositories/service-repository";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const services = await serviceRepository.findByBusinessId(business.id, includeInactive);
