  ...
  return (
    <div className="bg-background w-full">
      ...
      <SiteHeader
        ...
        desc="Manage your business locations and service areas"
      />
          ...
          <>
              ...
              <Card>
                <CardContent className="flex min-h-[300px] flex-col items-center justify-center p-12 text-center">
                  ...
                  <p className="mb-6 text-sm">
                    Add your first business location to enable location-based
                    features and help customers find you.
                  </p>
                  <Button onClick={handleAddLocation}>
                    <Plus className="mr-2 h-4 w-4" />
            ...
            <AlertDialog
              ...
              onOpenChange={(open: boolean) =>
                !open && setDeletingLocationId(null)
              }
            >
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    cannot be undone. All bookings and availability settings for
                    this location will be affected.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
