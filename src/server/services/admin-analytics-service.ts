...
import { businesses, appointments, categories } from "@/server/db/schema";
import { eq, count, sql, desc, gte, and, lt } from "drizzle-orm";
...
export async function getAdminAnalytics(
  ...
  const bookingsGrowth =
    previousPeriodStats?.totalBookings && previousPeriodStats.totalBookings > 0
