...
export function useAccessibility<T extends HTMLElement>(
  ...
  const Label = useCallback(
    ({ children, ...props }: React.HTMLAttributes<HTMLLabelElement>) => (
  ...
  return {
    ...
    getFocusableElements: () =>
      containerRef.current
        ? FocusManager.getFocusableElements(containerRef.current)
        : [],
  };
}
...
export function useAccessibleGrid<T extends HTMLElement>(
  options: {
    rowCount: number;
    columnCount: number;
