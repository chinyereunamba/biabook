...
const customerFormSchema = z.object({
    name: z.string()
        ...
        .refine((name) => name.trim().split(/\s+/).length >= 1, "Please enter your full name"),
    email: z.string()
...
export function CustomerForm({
    ...
    const isFormValid = formData.name && formData.email && formData.phone && !hasErrors;
            ...
            <CardContent className="p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Textarea
                                ...
                                className={`pl-10 min-h-[80px] resize-none ${errors.notes ? 'border-red-500 focus:border-red-500' : ''}`}
                    ...
                    <p className="text-xs text-gray-500 text-center">
                        By booking, you agree to receive appointment confirmations and reminders via email and SMS.
                        Your information will only be shared with the business you're booking with.
                    </p>
                </form>
            </CardContent>
        </Card>
